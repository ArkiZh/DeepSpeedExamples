...
import sys
sys.argv.extend("--local_rank 0 --dataset_name wikitext --dataset_config_name wikitext-2-raw-v1 --model_name_or_path tiiuae/falcon-7b  --per_device_train_batch_size 4 --num_train_epochs 0 --deepspeed_config config/ds_config_W8A8_Qgroup64_fp32.json --deepspeed --output_dir ./output/W8A8_falcon".split())
print(f"argv:\n{sys.argv}")
import os
